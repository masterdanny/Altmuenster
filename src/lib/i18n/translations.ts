...
const de = {
  ...
  common: {
    ...
    coatOfArms: "Wappen der Marktgemeinde Altmünster",
    coatOfArmsCredit: "Wappen: Wikimedia Commons (gemeinfrei)",
...
const en = {
  ...
  common: {
    ...
    coatOfArms: "Coat of arms of Altmünster",
    coatOfArmsCredit: "Coat of arms: Wikimedia Commons (public domain)",
