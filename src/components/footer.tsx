    ...
    >
      <div className="container-wide section-padding !py-12 sm:!py-16">
        <div className="sm:hidden">
          {brandBlock}
          <ShowMore
            label={t.footer.showContact}
            labelLess={t.common.showLess}
            variant="on-dark"
            contentClassName="mt-6 grid gap-8"
          >
            {exploreColumn}
            {municipalityColumn}
            {officialColumn}
        ...
        <div className="hidden gap-8 sm:grid sm:gap-12 md:grid-cols-2 lg:grid-cols-4">
          {brandBlock}
          {exploreColumn}
          {municipalityColumn}
          {officialColumn}
